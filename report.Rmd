...
## Conclusões
Relativamente a melhorias que poderiam ter sido feitas, na parte incial do trabalho, se em vez de termos apagado as linhas que continham missing values na **region** tivessem sido estimados os valores de acordo com atributos semelhantes poderia ter sido obtido um melhor desempenho no nosso modelo.
